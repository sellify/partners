...
return [
    'backup' => [
        ...
        'destination' => [
             ...
             */
            'filename_prefix' => env('APP_NAME') . '_' . env('APP_ENV') . '__',
    ...
    'notifications' => [
        ...
        'slack' => [
            'webhook_url' => env('BACKUP_NOTIFICATION_URL'),

            /*
             * If this is set to null the default channel of the webhook will be used.
             */
            'channel' => env('BACKUP_NOTIFICATION_CHANNEL'),

            'username' => env('BACKUP_NOTIFICATION_UESERNAME'),
